...
The main contents for the peeano. The folder includes the file for the website, index.html, the p5.js library, other related p5.js libraries, and sketch.js which holds the main code.
...
The sketch.js is the p5.js sketch, with the functions setup() and draw() that you can complete.
